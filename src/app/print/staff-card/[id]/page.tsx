...
import { StaffCardPrint } from "@/components/staff-card-print";

interface StaffCardPageProps {
  params: { id: string };
}

export default function PrintStaffCardPage({ params }: StaffCardPageProps) {
  ...
  useEffect(() => {
    const fetchCard = async () => {
      try {
        const res = await fetch(`/api/staff-card/${params.id}`, {
          credentials: "include",
        });
